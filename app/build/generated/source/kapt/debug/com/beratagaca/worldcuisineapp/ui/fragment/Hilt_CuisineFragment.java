...
public abstract class Hilt_CuisineFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CuisineFragment() {
    super();
  }

  Hilt_CuisineFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CuisineFragment_GeneratedInjector) this.generatedComponent()).injectCuisineFragment(UnsafeCasts.<CuisineFragment>unsafeCast(this));
    }
  }
