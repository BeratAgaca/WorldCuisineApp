...
public abstract class FragmentHomeBinding extends ViewDataBinding {
  ...
  @Bindable
  protected String mHomeToolbarTitle;

  protected FragmentHomeBinding(Object _bindingComponent, View _root, int _localFieldCount,
      RecyclerView countryRv, Toolbar toolbar) {
    super(_bindingComponent, _root, _localFieldCount);
    this.countryRv = countryRv;
    this.toolbar = toolbar;
  }

  public abstract void setHomeToolbarTitle(@Nullable String homeToolbarTitle);

  @Nullable
  public String getHomeToolbarTitle() {
    return mHomeToolbarTitle;
  }
